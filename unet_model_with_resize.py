...
class UNET(nn.Module):
    def __init__(
            ...
            self, in_channels=3, out_channels=3, features=[64, 128, 256, 512], resize=(256, 256),
    ):
    ...
    def forward(self, x):
        ...
        x = TF.resize(x, size=self.resize, interpolation=TF.InterpolationMode.BILINEAR)
        ...
        x = self.final_conv(x)
        x = TF.resize(x, size=original_size, interpolation=TF.InterpolationMode.BILINEAR)
